...
training <- read.csv(file='/Users/gaoyang/desktop/pml-training.csv',na.string=c("","NA"))
testing <- read.csv(file='/Users/gaoyang/desktop/pml-testing.csv',na.string=c("","NA"))
```
